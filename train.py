...
def stacked_class(name):
    ...
    baseline_model_xgb_cn = xgb.XGBClassifier(objective="binary:logistic",n_estimators=100, learning_rate=0.3, max_depth=6, random_state=1).fit(xcn_train, y_train) #500
